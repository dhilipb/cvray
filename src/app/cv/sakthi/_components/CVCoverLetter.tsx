...
export const CVCoverLetter = ({ data, isHeadhunterMode }: CVCoverLetterProps) => (
  <Document
    title={`Cover Letter - ${isHeadhunterMode ? "Candidate" : data.name}`}
  ...
  >
    <Page size="A4" style={styles.page}>
      ...
      <View style={{ marginTop: 24 }}>
        <Text style={{ fontSize: 10, lineHeight: 1.6, color: COLORS.body, fontFamily: "Inter" }}>
          {renderText(data.coverLetter || "")}
        </Text>
      </View>
      <Text
        style={{
